...
_lr_productions = [
  ...
  ('block -> CLSS NAME blockcontent END','block',4,'p_block','parser.py',52),
  ('block -> CLSS blockcontent END','block',3,'p_block','parser.py',53),
  ('block -> CLSS NAME END','block',3,'p_block','parser.py',54),
  ('block -> CLSS END','block',2,'p_block','parser.py',55),
