...
_lr_productions = [
  ...
  ('block -> CLASS NAME blockcontent END','block',4,'p_block','parser.py',52),
  ('block -> CLASS blockcontent END','block',3,'p_block','parser.py',53),
  ('block -> CLASS NAME END','block',3,'p_block','parser.py',54),
  ('block -> CLASS END','block',2,'p_block','parser.py',55),
  ('blockcontent -> blockcontent attr','blockcontent',2,'p_blockcontent','parser.py',72),
  ('blockcontent -> blockcontent block','blockcontent',2,'p_blockcontent','parser.py',73),
  ('blockcontent -> attr','blockcontent',1,'p_blockcontent','parser.py',74),
  ('blockcontent -> block','blockcontent',1,'p_blockcontent','parser.py',75),
  ('attr -> ATTR expr','attr',2,'p_attrset','parser.py',93),
  ('attr -> BODY','attr',1,'p_attrset','parser.py',94),
  ('expr -> expr PLUS term','expr',3,'p_binops','parser.py',104),
  ('expr -> expr MINUS term','expr',3,'p_binops','parser.py',105),
  ('expr -> term','expr',1,'p_binops','parser.py',106),
  ('term -> term TIMES factor','term',3,'p_binops','parser.py',107),
  ('term -> term DIVIDE factor','term',3,'p_binops','parser.py',108),
  ('term -> term TIMES TIMES factor','term',4,'p_binops','parser.py',109),
  ('term -> term DIVIDE DIVIDE factor','term',4,'p_binops','parser.py',110),
  ('term -> factor','term',1,'p_binops','parser.py',111),
  ('factor -> NUM_INT','factor',1,'p_factor_num','parser.py',126),
  ('factor -> NUM_FLOAT','factor',1,'p_factor_num','parser.py',127),
  ('factor -> NUM_HEX','factor',1,'p_factor_num','parser.py',128),
  ('factor -> NUM_OCT','factor',1,'p_factor_num','parser.py',129),
  ('factor -> NUM_IMAG','factor',1,'p_factor_num','parser.py',130),
  ('factor -> NUM_BIN','factor',1,'p_factor_num','parser.py',131),
  ('factor -> PLUS factor','factor',2,'p_factor_num','parser.py',132),
  ('factor -> MINUS factor','factor',2,'p_factor_num','parser.py',133),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_paren_expr','parser.py',142),
  ('factor -> STRING','factor',1,'p_factor_str','parser.py',148),
  ('factor -> BOOL','factor',1,'p_factor_bool','parser.py',154),
  ('factor -> NONE','factor',1,'p_factor_none','parser.py',159),
  ('factor -> identifier','factor',1,'p_factor_id','parser.py',165),
  ('factor -> func','factor',1,'p_factor_id','parser.py',166),
  ('func -> ID LPAREN funcargs RPAREN','func',4,'p_func','parser.py',171),
  ('func -> ID LPAREN RPAREN','func',3,'p_func','parser.py',172),
  ('funcargs -> funcargs COMMA expr','funcargs',3,'p_funcargs','parser.py',180),
  ('funcargs -> expr','funcargs',1,'p_funcargs','parser.py',181),
  ('identifier -> factor DOT func','identifier',3,'p_id_func','parser.py',190),
  ('identifier -> identifier DOT func','identifier',3,'p_id_func','parser.py',191),
  ('identifier -> identifier DOT ID','identifier',3,'p_id','parser.py',196),
  ('identifier -> factor DOT ID','identifier',3,'p_id','parser.py',197),
  ('identifier -> func','identifier',1,'p_id','parser.py',198),
  ('identifier -> ID','identifier',1,'p_id','parser.py',199),
  ('identifier -> identifier LARRAY expr RARRAY','identifier',4,'p_id_index','parser.py',211),
  ('arraydata -> arraydata COMMA expr','arraydata',3,'p_arraydata','parser.py',218),
  ('arraydata -> expr','arraydata',1,'p_arraydata','parser.py',219),
  ('factor -> LARRAY arraydata RARRAY','factor',3,'p_factor_arr','parser.py',229),
  ('factor -> LARRAY arraydata COMMA RARRAY','factor',4,'p_factor_arr','parser.py',230),
  ('factor -> LARRAY RARRAY','factor',2,'p_factor_arr','parser.py',231),
  ('dictdata -> dictdata COMMA dictcouple','dictdata',3,'p_dictdata','parser.py',240),
  ('dictdata -> dictcouple','dictdata',1,'p_dictdata','parser.py',241),
  ('expr -> NOT expr','expr',2,'p_not','parser.py',250),
  ('dictdata -> dict','dictdata',1,'p_dict_dictdata','parser.py',255),
  ('dictcouple -> expr COLON expr','dictcouple',3,'p_factor_dictcouple','parser.py',260),
  ('dict -> LDICT dictdata RDICT','dict',3,'p_factor_dict','parser.py',265),
  ('dict -> LDICT dictdata COMMA RDICT','dict',4,'p_factor_dict','parser.py',266),
  ('dict -> LDICT RDICT','dict',2,'p_factor_dict','parser.py',267),
  ('factor -> dict','factor',1,'p_dict','parser.py',272),
]
